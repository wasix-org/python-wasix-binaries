...
#define CONFIGURE_ARGS " '--host=aarch64-apple-darwin' '--without-icu' '--without-readline' '--enable-static' 'PG_SYSROOT=/opt/wasix-sysroot' 'CC=clang-15 --target=wasm32-wasi --sysroot=/opt/wasix-sysroot' 'CFLAGS=-matomics -mbulk-memory -mmutable-globals -pthread -mthread-model posix -ftls-model=local-exec     -fno-trapping-math -D_WASI_EMULATED_MMAN -D_WASI_EMULATED_SIGNAL -D_WASI_EMULATED_PROCESS_CLOCKS     -g -flto -O2     -L/Users/arshia/repos/wasmer/php-8.2/postgresql/../php-wasix-deps/lib     -I/Users/arshia/repos/wasmer/php-8.2/postgresql/../php-wasix-deps/include/zlib     -I/Users/arshia/repos/wasmer/php-8.2/postgresql/../php-wasix-deps/include/openssl     ' 'host_alias=aarch64-apple-darwin'"
...
#define PG_VERSION_STR "PostgreSQL 16.3 on aarch64-apple-darwin, compiled by Homebrew clang version 15.0.7, 32-bit"

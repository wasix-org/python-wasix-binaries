...
#define CONFIGURE_ARGS " '--host=wasm32-wasi' '--with-icu' '--without-readline' '--with-ssl=openssl' '--prefix=/home/arshia/repos/wasmer/php/postgres/install' '--exec-prefix=/home/arshia/repos/wasmer/php/postgres/install' '--with-template=wasix' 'PG_SYSROOT=/home/arshia/.wasix-sysroot/sysroot-ehpic' 'CC=wasixcc' 'RANLIB=wasixranlib' 'AR=wasixar' 'CFLAGS=-g -flto -O2 -fvisibility=default     -L/home/arshia/repos/wasmer/python/python-wasix-binaries/lib     -I/home/arshia/repos/wasmer/python/python-wasix-binaries/include/zlib     -I/home/arshia/repos/wasmer/python/python-wasix-binaries/include/openssl     -I/home/arshia/repos/wasmer/python/python-wasix-binaries/include/icu     ' 'host_alias=wasm32-wasi'"
...
#define PG_VERSION_STR "PostgreSQL 16.3 on wasm32-unknown-wasi, compiled by wasixcc version: 0.2.2, 32-bit"
